...
function ArticlesOfAmendment({ edit }) {
  ...
  const documentTrueOptions = [
    {
      value: "Manager Managing",
      label: "Manager Managing",
    },
    {
      value: "Member",
      label: "Member",
  ...
  const formik = useFormik({
    initialValues: {
      ...
      foreignIndividual:
        formData?.foreignIndividual === false
          ...
          : false,
      documentTrue:
        formData?.documentTrue === false
          ? false
          : formData?.documentTrue === true
          ? true
          : true,
      ...
      documentTrueFirstName: formData?.documentTrueFirstName || "",
      documentTrueLastName: formData?.documentTrueLastName || "",
      documentTrueState: {
        label: formData?.documentTrueState?.label || "Select any",
        value: formData?.documentTrueState?.value || "",
      },
    },
    validationSchema: Yup.object({
      ...
      documentTrueFirstName: Yup.string().when("documentTrue", {
        is: true,
        then: Yup.string().required("Required"),
      }),
      documentTrueLastName: Yup.string().when("documentTrue", {
        is: true,
        then: Yup.string().required("Required"),
      }),
      documentTrueState: Yup.object().when("documentTrue", {
        is: true,
        ...
        <Row>
          <Col lg={12}>
            <div className={styles.textblock}>
              <h1 className={styles.heading}>Annual Report</h1>
            </div>
            ...
            {formik.values.entityType.value && (
              <DetailCard title="You are required by your state to affirm the following.">
                <p>
                  I am a manager or managing member of{" "}
                  {formik.values.entityType.label} or I have been authorized to
                  submit this report on the entity's behalf. The information
                  contained in this Statement of Information filing is true and
                  correct.
                </p>
                <div
                  className={styles.formInpWrapper}
                ...
                >
                  <Form.Check
                    ...
                    type="radio"
                    checked={
                      formik.values?.documentTrue === true ? true : false
                    }
                    onChange={() =>
                      formik.setValues({
                        ...formik.values,
                  ...
                  <Form.Check
                    ...
                    label="No"
                    checked={
                      formik.values?.documentTrue === false ? true : false
                    }
                    onChange={() =>
                      formik.setValues({
                        ...formik.values,
                ...
                {formik.values.documentTrue && (
                  <div className="mt-4">
                    <div className="mb-3">
                      <InputField
                        label="First Name *"
                        name="documentTrueFirstName"
                        type="text"
                        value={formik.values.documentTrueFirstName}
                        error={formik.errors.documentTrueFirstName}
                        onChange={formik.handleChange}
                      />
                    </div>
                    <div className="mb-3">
                      <InputField
                        label="Last Name *"
                        name="documentTrueLastName"
                        type="text"
                        value={formik.values.documentTrueLastName}
                        error={formik.errors.documentTrueLastName}
                        onChange={formik.handleChange}
                      />
                    </div>
                    <div className="mb-3">
                      <CustomSelect
                        ...
                        name="title"
                        placeholder="Select State"
                        options={documentTrueOptions}
                        value={formik.values.documentTrueState}
                        onChange={(e) => {
                          formik.setValues({
                            ...formik.values,
                            documentTrueState: e,
                      ...
                      <p className="error-message">
                        {formik.errors.documentTrueState?.value}
                      </p>
                    </div>
                  </div>
                )}
                {formik.values.documentTrue === false && (
                  <>
                    <p className="error-message mt-3">
                      You are required affirm the following{" "}
                    </p>
                  </>
                )}
              </DetailCard>
