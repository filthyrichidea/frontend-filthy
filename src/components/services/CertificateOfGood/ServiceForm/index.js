          ...
          <Col lg={8}>
            <div className={styles.textblock}>
              ...
              <p className={styles.tagline}>
                A Certificate of Good Standing is a legal document that confirms
                a company is officially recognized and allowed to do business.
                It shows other businesses, customers, creditors and partners
                that the company is legitimate, authorized, and is up to date in
                state fees.
              </p>
              <p className={styles.tagline}>
                It is sometimes referred to as a “Certificate of Existence” or
                “Certificate of Authorization.” With Filthy Rich Idea, this
