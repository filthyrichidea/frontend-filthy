...
function RegisteredServiceForm({ edit }) {
        ...
        <Row>
          <Col lg={12}>
            <div className={styles.textblock}>
              <h1 className={styles.heading}>Registered Agent Service</h1>
            </div>
            ...
            <div className={styles.amendmentInfo}>
              ...
              <Form className={styles.form}>
                ...
                <div className="ms-3 mb-3">
                  <Form.Check
                    ...
                    type="radio"
                    value={formik.values.agentRegistered}
                    checked={
                      formik.values.agentRegistered === true ? "checked" : ""
                    }
                    onChange={() =>
                      formik.setValues({
                        ...formik.values,
                  ...
                  <Form.Check
                    ...
                    name="agentRegistered"
                    checked={
                      formik.values.agentRegistered === false ? "checked" : ""
                    }
                    value={formik.values.agentRegistered}
                    onChange={() =>
                      formik.setValues({
                ...
                {/* <p>Select No, if entity has not been filled.</p> */}
              </Form>
              ...
              <div className={styles.cardblock}>
                <div className={styles.card}>
                  ...
                  <div className={styles.textblock}>
                    <p className={styles.subtitle}>
                      It is compulsory that the necessary paperwork to transfer
                      the registered agent service is filed if the entity has a
                      current registered agent already recorded. We offer our
                      clients the choice of allowing us to submit the essential
                      forms on their behalf as a courtesy. Unless the state has
                      received these documents, it will not accept that a new
                      registered agent has been appointed.
                    </p>
                  </div>
                </div>
              </div>
                        ...
                        <div>
                          ...
                          <p>
                            <b>
                              <span>
                                {moment(
                                  date3.setDate(date2.getDate() + Number(1))
                                ).format("MMM Do")}
                              </span>
                            </b>
                          </p>
...
export default RegisteredServiceForm
