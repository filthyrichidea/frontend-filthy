          ...
          <Col lg={7}>
            <div className={styles.textblock}>
              ...
              <p className={styles.tagline}>
                Business owners can get an EIN by filing IRS Form SS-4. Incfile
                ...
                Michigan or anywhere in the United States, Incfile can provide
                one for you in one day. Apply for an EIN online with Incfile,
